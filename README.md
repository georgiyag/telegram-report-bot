...
📖 **Подробная инструкция**: [QUICK_START.md](QUICK_START.md) | [DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md)
...
git clone https://github.com/georgiyag/telegram-report-bot.git
